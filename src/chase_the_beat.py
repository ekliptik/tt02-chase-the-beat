...
class Noise(Elaboratable):
    ...
    def elaborate(self, _):
        m = Module()
        # Generated by random.randint(1,2**22)
        lfsr_inits = [626567, 2507694, 3184372, 352821, 1813678, 155234, 3142325, 1157797]
        for lfsr_idx in range(8):
            # Max length external feedback LFSR with n = 22, P(x) = x**n + x + 1
            length = 22
