...
module noise(rst, clk, o);
  ...
  input clk;
  wire clk;
  (* src = "/home/emil/pulls/tt02-verilog-demo/src/chase_the_beat.py:38" *)
  output o;
  reg o = 1'h0;
  (* src = "/home/emil/pulls/tt02-verilog-demo/src/chase_the_beat.py:38" *)
  reg \o$next ;
  ...
  reg [6:0] shift_reg = 7'h01;
  (* src = "/home/emil/pulls/tt02-verilog-demo/src/chase_the_beat.py:44" *)
  reg [6:0] \shift_reg$next ;
  assign \$1  = shift_reg[6] ^ (* src = "/home/emil/pulls/tt02-verilog-demo/src/chase_the_beat.py:46" *) shift_reg[1];
  always @(posedge clk)
    o <= \o$next ;
  always @(posedge clk)
...
module top(mode, o, clk, rst, tap);
  ...
  input tap;
  wire tap;
  assign \$1  = mode ? (* src = "/home/emil/pulls/tt02-verilog-demo/src/chase_the_beat.py:65" *) chase_o : { 7'h00, noise_o };
  chase chase (
    .clk(clk),
    .o(chase_o),
    .rst(rst),
